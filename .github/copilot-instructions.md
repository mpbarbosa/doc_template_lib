...
- **Scope**: This repository is documentation-first. Most changes are to Markdown guides and configuration files.
...
- Keep each guide focused on a single principle or subject area. Avoid merging unrelated topics.
...
- Keep documents actionable: favor rules, signals, heuristics, and checklists over long narrative discussion.
- When adding or updating guides, mirror the structure and style of existing documents for consistency.
- Align `.workflow-config.yaml` with the actual repository scope and usage.

For further details or updates, always refer to the authoritative [README.md](../README.md).
